...
// Last update Sat Apr 30 10:12:37 2016 Victor Gouet
//
...
int	main()
{
  ...
  Player	sydney("ROGER", irr::core::vector3df(-100, 0, -100), "media/ziggs_general.md3", "media/ziggs_general.png", 0, eventGame);
